...
choose=train_data[1]
indir=r"D:\倒生树\书\\1训练集\processed\\"+choose

#output dir
file_n=os.listdir(indir)
print(file_n)
outdir=r"D:\倒生树\书\\1训练集\processed\\train.txt"
...
f2.write("\"]")
f2.close()
os.rename(r"D:\倒生树\书\\1训练集\processed\\train.txt",r"D:\倒生树\书\\1训练集\processed\\train.json")
